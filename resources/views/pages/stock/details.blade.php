        ...
        @if($product)
            ...
            <div class="row g-2 mb-1">
                ...
                <div class="col-5">
                    <div class="form-floating">
                        <div class="form-floating">
                            <input type="number" class="form-control" id="price" name="price" placeholder="Price" value="{{number_format($product->price,2,'.',',')}}">
                ...
                <div class="col-5">
                    <div class="form-floating">
                        <input type="text" class="form-control" id="amount" name="amount" placeholder="Amount" value="{{$product->amount}}">
