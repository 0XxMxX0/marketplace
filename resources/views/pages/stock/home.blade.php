    ...
    <div class="container">
        ...
        @if($stock->count())
            <ul class="nav p-2 justify-content-between rounded align-items-center border bg-body-tertiary">
                ...
                <li class="nav-item">
                    <a href="{{route('site.stock.create')}}" class="btn btn-outline-dark active" aria-current="page" >Create</a>
                </li>
            </ul>
            <table class="table">
                <thead>
                ...
                @foreach($stock as $productsDetails)
                    <tr>
                        ...
                        <td class="btn-group" role="group" aria-label="Basic outlined example">
                            <a href="{{route('stock.details', $productsDetails->id)}}" type="button"
                               class="btn btn-dark text-light">
                                <i class="bi bi-pencil-square"></i>
                            </a>

                            @include('pages.stock.modal.delete')
        ...
        @else
            ...
            <div class="text-center mt-4">
                ...
                <a href="{{route('site.stock.create')}}" class="btn mt-2 btn-outline-dark active" aria-current="page">Create Product</a>
            </div>
